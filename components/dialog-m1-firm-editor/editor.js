var t = require("../../AC1F69C355C842DFCA7901C4DB75D685.js");
...
Component({
    ...
    methods: {
        ...
        onUserConfirm: function() {
            ...
            var s = t.hex2bytes(this.data.inputList.uid.value), n = s[0] ^ s[1] ^ s[2] ^ s[3], u = this.data.inputList.uid.value, o = t.bytes2hex([ n ]), r = this.data.inputList.sak.value, c = this.data.inputList.atqa.value, l = this.data.inputList.manufacturer.value, d = "".concat(u).concat(o).concat(r).concat(c).concat(l);
