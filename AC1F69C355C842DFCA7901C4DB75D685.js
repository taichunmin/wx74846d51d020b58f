...
module.exports = {
    ...
    bytes2DarksideObj: function(r) {
        return (r instanceof Uint8Array || r instanceof Array) && 32 == r.length ? {
            uid: u(r, 0, 4),
            nt1: u(r, 4, 4),
            par: s(r, 8, 8),
            ks1: s(r, 16, 8),
    ...
    mergeDarksideObjs: function(r, e, n) {
        var t = {}, o = [];
        return t.uid = n[0].uid, t.keyA = f(e), t.block = "" + r, n.forEach(function(r, e) {
            o.push({
                ntp: r.nt1,
                par: r.par,
                ks1: r.ks1,
    ...
    bytes2RF08s2x1NTObj: function(r) {
        return (r instanceof Uint8Array || r instanceof Array) && 22 == r.length ? {
            uid: u(r, 0, 4),
            typea: {
                nt: u(r, 4, 4),
                nt_enc: u(r, 8, 4),
        ...
        } : (console.log("bytes2RF08s2x1NTObj 发现传入的数据不符合规范！"), null);
    }
};